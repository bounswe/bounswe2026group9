...
function toApiTemporalFilter(value: string | null): "today" | "this_week" | undefined {
  return value === "today" || value === "this_week" ? value : undefined;
}
    ...
    const fetchGeo = async () => {
      try {
        const res = await fetchGeoJsonEvents({
          ...
          temporal_filter: toApiTemporalFilter(searchParams.get("temporal")),
        });
